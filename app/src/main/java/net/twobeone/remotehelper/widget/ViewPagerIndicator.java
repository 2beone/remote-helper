package net.twobeone.remotehelper.widget;
...
public class ViewPagerIndicator extends View implements ViewPager.OnPageChangeListener {
    ...
    private void init(AttributeSet attrs) {
        ...
        circleRadius = (int) getResources().getDimension(R.dimen.indicator_circle_radius);
        circlePadding = (int) getResources().getDimension(R.dimen.indicator_circle_padding);
        ...
        if (attrs != null) {
            TypedArray a = getContext().getTheme().obtainStyledAttributes(attrs, R.styleable.ViewPagerIndicator, 0, 0);
            circleRadius = (int) a.getDimension(R.styleable.ViewPagerIndicator_indicatorRadius, circleRadius);
            circlePadding = (int) a.getDimension(R.styleable.ViewPagerIndicator_indicatorPadding, circlePadding);
            inactiveColor = a.getColor(R.styleable.ViewPagerIndicator_indicatorInactiveColor, inactiveColor);
            activeColor = a.getColor(R.styleable.ViewPagerIndicator_indicatorActiveColor, activeColor);
            mGravity = a.getInt(R.styleable.ViewPagerIndicator_android_gravity, gravity);
        }
